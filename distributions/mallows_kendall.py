...
from distributions.mallows_model import check_theta_phi, phi_to_theta
...
def expected_dist_mm(n, theta=None, phi=None):
    """The function computes the expected distance of Kendall's-tau distance under Mallows algorithm (MMs).
        Parameters
        ----------
        n: int
...
def fit_mm(rankings, s0=None):
    ...
    dispersion parameter phi for MM algorithm.
        Parameters
        ----------
        rankings: ndarray
...
def fit_gmm(rankings, s0=None):
    ...
    dispersion parameters theta_j for GMM algorithm
        Parameters
        ----------
        rankings: ndarray
            The matrix of permutations
