...
from metrics.metrics import mse, mae, smape, mape, prauc, gaussian_likelihood, get_range_vus_roc, best_f1_linspace, adjusted_precision_recall_f1_auc
...
def rank_by_metrics(predictions: dict, n_splits=100, sliding_window=None) -> pd.DataFrame:
    """Rank algorithm based on their observed (adjusted) PR-AUCs, Best F-1 and VUS.
